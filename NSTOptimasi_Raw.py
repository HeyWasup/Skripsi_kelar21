...
def load_image(image_path, max_size=512, device='cuda'):
    """
    Loads an image from disk, scales to max_size x max_size, and converts to a tensor.
    """
...
# =============================================================================
# 3. Load Content (Fractal) & Style Images
# =============================================================================
device = torch.device("cuda")  # Gunakan GPU secara eksplisit
...
# =============================================================================
# 7. Define an Optimizer & Loss Function with Mixed Precision
# =============================================================================
optimizer = optim.LBFGS([generated_img])
max_steps = 150  # Jumlah iterasi dikurangi untuk menghemat waktu
iteration = [0]

# Gunakan torch.cuda.amp untuk mixed precision
...
# =============================================================================
save_tensor_image(generated_img, "fractal_stylized_output4.jpg")
print("Style transfer completed and image saved as 'fractal_stylized_output4.jpg'.")